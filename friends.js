      ...
      firebase
        ...
        .onSnapshot((users) => {
          ...
          users.forEach((userdetail) => {
            ...
            userimg.setAttribute("src", "avatardefault_92824.png");
            ...
            usercoverimg.setAttribute("src", "ForestLightning.jpg");
            ...
            userprofileimg.setAttribute("src", "avatardefault_92824.png");
            if (userdetail.data().ProfilePicture !== "") {
